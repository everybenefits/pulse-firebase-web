...
export function mapOrgNode(entry: Record<string, unknown>): OrgNode {
  ...
  return {
    ...
    ownerUids: Array.isArray(entry.ownerUids)
      ...
      : [],
    owners: Array.isArray(entry.owners)
      ? entry.owners
          .map((row) =>
            row && typeof row === "object"
              ? {
                  uid: String((row as Record<string, unknown>).uid ?? ""),
                  displayName:
                    typeof (row as Record<string, unknown>).displayName ===
                    "string"
                  ...
                  email:
                    typeof (row as Record<string, unknown>).email === "string"
                      ...
                      : null,
                  photoUrl:
                    typeof (row as Record<string, unknown>).photoUrl === "string"
                      ? ((row as Record<string, unknown>).photoUrl as string)
                      : null,
                }
              : null,
          )
